...
<div class="container-fluid p-4" style="background-color:#E9ECEF">
    <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
            ...
            <div class="col-sm">
                <h5>Category</h5>
                <a class="text-dark" href="#">Java Script</a><br />
                <a class="text-dark" href="#">CSS</a><br />
                <a class="text-dark" href="#">HTML</a><br />
                <a class="text-dark" href="#">C</a><br />
                <a class="text-dark" href="#">C++</a><br />
                <a class="text-dark" href="#">Data Science</a><br />
            </div>
            <div class="col-sm">
                <h5>Contact Us</h5>
                <p>E Learning Pvt Ltd <br> Bardoli <br> Surat Gujarat <br> Ph. 000000000 </p>
            </div>
        </div>
    </div>
